...
object AnimalZioService:
  ...
  def zioLayer: RLayer[QuillPlatform, AnimalZioService] =
    ZLayer {
      for {
...
object QuillRepoSpec extends ZIOSpecDefault:
  ...
  override def spec: Spec[TestEnvironment & Scope, Throwable] = {
    suite("Zoo repository test with postgres test container")(
      ...
      containerLayer, dataSourceBuilderLayer, dataSourceLayer, postgresQuill, quillPlatformLayer, animalServiceLayer
    ) @@ sequential
  }
