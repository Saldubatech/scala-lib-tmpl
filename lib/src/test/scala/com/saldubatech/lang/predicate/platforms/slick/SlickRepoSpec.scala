package com.saldubatech.lang.predicate.platforms.slick
...
import com.saldubatech.infrastructure.storage.PersistenceError
import com.saldubatech.lang.predicate.Repo
import com.saldubatech.lang.predicate.platforms.{SlickPlatform, SlickRepoZioService}

case class Animal(animal: String, size: Int, age: Double)

class AnimalZioService(using ExecutionContext)(val platform: SlickPlatform) extends SlickRepoZioService[Animal](platform):
...
object AnimalZioService:
  ...
  def zioLayer: URLayer[SlickPlatform & ExecutionContext, AnimalZioService] =
    ZLayer {
      for {
...
object SlickRepoSpec extends ZIOSpecDefault:
  ...
  override def spec: Spec[TestEnvironment & Scope, Throwable] = {
    suite("Zoo repository test with postgres test container")(
      ...
      execContextLayer, postgresProfileLayer, containerLayer, dataSourceBuilderLayer, dataSourceLayer, dbProviderLayer,
      slickPlatformLayer, animalServiceLayer
    ) @@ sequential
  }
